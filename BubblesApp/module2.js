...
class Arrow {
    ...
    draw(context) {
        ...
        context.lineTo(this.xpoint+25, this.ypoint-25);
        context.lineTo(this.xpoint+25, this.ypoint-10);
        context.lineTo(this.xpoint+90, this.ypoint-10);
        context.lineTo(this.xpoint+90, this.ypoint+5);
        context.lineTo(this.xpoint+25, this.ypoint+5);
        context.lineTo(this.xpoint+25, this.ypoint+20);
...
let Arrow1 = new Arrow(1150,100,4);
Arrow1.draw(context);
...
circle2.draw(context);
let Arrow2 = new Arrow(1150,250,4);
Arrow2.draw(context);
...
circle3.draw(context);
let Arrow3 = new Arrow(1150,400,4);
Arrow3.draw(context);
...
circle4.draw(context);
let Arrow4 = new Arrow(1150,550,4);
Arrow4.draw(context);
